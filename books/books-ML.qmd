---
title: "моделирование и машинное обучение"
---
...
Книги и ресурсы по моделированию и машинному обучению.

```{r}
#| echo: false
#| warning: false
modeling <- read_excel("../tables/modeling.xlsx")
...
reactable(
  ...
  columns = list( 
    ...
    title = colDef(
      ...
      sprintf('<a href="%s" target="_blank">%s</a>', modeling$link[index], value)
      }
    ),
    author = colDef(
      sortable = FALSE,
