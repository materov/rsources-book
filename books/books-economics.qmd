...
Книги и ресурсы по экономике и смежным вопросам.

```{r}
#| echo: false
#| warning: false
economics <- read_excel("../tables/economics.xlsx")
...
reactable(
  ...
  columns = list( 
    ...
    title = colDef(
      ...
      sprintf('<a href="%s" target="_blank">%s</a>', economics$link[index], value)
      }
    ),
    author = colDef(
      sortable = FALSE,
