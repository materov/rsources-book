...
В таблице приведены книги англоязычных авторов, в основном по языку программирования **R** и *Data Science*.

```{r}
#| echo: false
#| warning: false
books_eng <- read_excel("../tables/books_eng.xlsx")
...
reactable(
  ...
  columns = list( 
    ...
    title = colDef(
      ...
      sprintf('<a href="%s" target="_blank">%s</a>', books_eng$link[index], value)
      }
    ),
    author = colDef(
      sortable = FALSE,
