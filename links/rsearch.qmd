...
#| echo: false
#| warning: false
rsearch <- read_excel("../tables/rsearch.xlsx")
...
reactable(
  ...
  columns = list(
    link = colDef(
      ...
      sprintf('<a href="%s" target="_blank">%s</a>', rsearch$link[index], value)
      }
    ),
    title = colDef(
      name = "Ресурс",
