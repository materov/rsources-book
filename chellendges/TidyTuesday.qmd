...
*[TidyTuesday](){target="_blank"}* --- это социальный еженедельный информационный проект, который в первую очередь направлен на экосистему **R**. Каждую неделю на сайте проекта и в социальных сетях публикуется необработанный набор данных, небольшая сопроводительная диаграмма и статья с описанием. Прекрасный пример визуализаций проекта **TidyTuesday** --- дэшборд, который сделала *Nicola Rennie*.
